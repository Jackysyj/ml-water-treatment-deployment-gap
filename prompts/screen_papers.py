...
Input: data/literature/screening/filtered_papers.json
Output: data/literature/screening/screening_results.json + final_doi_list.txt
...
from paths import FINAL_DOI_LIST, SCREENING_DIR
