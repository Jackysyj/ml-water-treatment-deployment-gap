...
Input: data/processed/supplement_filtered.json
Output: data/processed/supplement_screening.json
...
SCREENING_PROMPT = """You are screening papers for a Water Research Critical Review on "Machine Learning in Water Treatment: Bridging the Lab-to-Field Gap".
